...
## - renommez les ports utilisés (dans chaque ligne, après get_ports) en fonction des noms de signal de niveau supérieur dans le projet
...
## Déclarez-les uniquement si vous souhaitez utiliser les broches 15 et 16 comme entrées analogiques asymétriques. broche 15 -> vaux4, broche16 -> vaux12
